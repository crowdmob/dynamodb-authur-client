require 'dynamodb-authur-client/strategies/base'
    ...
    module Client
      module Strategies
        ...
        private
          ...
          def remember_me?
            valid_params? && Dynamodb::Authur::Client::TRUE_VALUES.include?(params_auth_hash[:remember_me])
          end
          ...
          def valid_params_request?
            !!env["dynamodb_authur_client.allow_params_authentication"]
          end
          ...
          # Holds the authenticatable name for this class. Dynamodb::Authur::Client::Strategies::DatabaseAuthenticatable
